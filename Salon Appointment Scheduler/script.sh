...
create table customers(customer_id serial primary key, phone varchar(15) unique, name varchar(30) );
create table services(service_id serial primary key, name varchar(40) );
